...
$config = array(
	...
	'mail_address' => 'info@flankera.com', // server e-mail address (from:)
	'mail_admin' => 'info@flankera.com', // admin email address, where mails from contact form will be sent
	'mail_signature' => array( // signature that will be included at the end of every message sent using _mail function
		'plain' => ""/*"--\nMy Server,\nhttp://www.flankera.com"*/,
		'html' => ''/*'<br/>My Server,\n<a href="http://www.flankera.com">flankera.com</a>'*/
	),
	'smtp_enabled' => true, // send by smtp or mail function (set false if use mail function)
	'smtp_host' => 'palm.arvixe.com', // mail host
	'smtp_port' => 465, // 25 (default) / 465 (ssl, e.g. gmail)
	'smtp_auth' => true, // need authorization?
	'smtp_user' => 'info@flankera.com',
	'smtp_pass' => '3343402Az',
	'smtp_secure' => 'ssl', // What kind of encryption to use on the SMTP connection. Options: '', 'ssl' or 'tls', use 'ssl' for gmail

	// reCAPTCHA (prevent spam bots)
	'recaptcha_enabled' => true, // enable recaptcha verification code
	'recaptcha_site_key' => '6Ldp_GwUAAAAALb9pOk8-dL62U_dhQWyV83ygmcn', // get your own site and secret keys at https://www.google.com/recaptcha
	'recaptcha_secret_key' => '6Ldp_GwUAAAAAGp8gfGQcoZl2FoA7r2LnsU1XESG',
...
$config['client_download'] = 'https://flankera.com/download/Flankera.exe/'. $config['client'] .'/exe/windows';
$config['client_download_linux'] = 'https://flankera.com/download/Flankera.exe/'. $config['client'] .'/tar/linux';
	...
	$config['paypal'] = array(
		'enabled' => true,
		'email' => 'ziad.checkout@gmail.com', // Example: paypal@mail.com
		'currency' => 'EUR',
	...
	$config['spinner_days'] = array("Saturday","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday");
?>
