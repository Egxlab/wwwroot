...
<div id='<?php echo $cat['id']; ?>' class='menuitem'>
	<span onClick="MenuItemAction('<?php echo $cat['id']; ?>')">
		<div class='MenuButton' style='background-image:url(<?php echo $template_path; ?>/images/menu/button-background.gif);'>
			<div onMouseOver='MouseOverMenuItem(this);' onMouseOut='MouseOutMenuItem(this);'><div class='Button' style='background-image:url(<?php echo $template_path; ?>/images/menu/button-background-over.gif);'></div>
				<span id='<?php echo $cat['id']; ?>_Lights' class='Lights' style="visibility: hidden;">
	...
	<div id='<?php echo $cat['id']; ?>_Submenu' class='Submenu' style="visibility: visible; display: block;">
	<?php
...
<img class="Title" src="templates/tibiacom/images/header/headline-newsticker.gif" alt="Contentbox headline">    <div class="Border_2">
        <div class="Border_3">
            <div class="BoxContent" style="background-image:url(./layouts/tibiacom/images/content/scroll.gif);">
               <div align="center"><font size="2px"><font face="Verdana"><b>➮ IP:</b> flankera.com <b>➮ Port:</b> 7171 <b>➮ Version:</b> 11.00 <b>➮ Client Flankera:</b> <a href="/index.php?subtopic=download">Download</a></font></font></div><font size="2px"><font face="Verdana">
				<br><div id="TeaserThumbnail"><img src="images/logo.gif" width="166px" height="82px" border="0" alt="" align="right" hspace="10"></div>
                <div id="TeaserText">
                    <div style="position: relative; top: -9px; margin-bottom: 10px;"><br>
				 <font size="2px"><font face="Verdana">➥ Seja bem vindo ao servidor alternativo <b>Flankera Global OTS</b>, o mais conceituado e mais completo servidor alternativo, contamos com <b>Mapa Global</b> contendo as mais recentes atualizações, principais quests, cooldown de magias ajustadas,  sistemas exclusivos, eventos automaticos, muita guerra entre guilds e muito mais. Temos uma otima equipe trabalhando em correções de bugs e melhorias para o game. Online desde 01 de março de 2017, desde seu surgimento o flankeravem conquistando a cada dia mais jogadores que querem dedicar seu tempo a um servidor que tem compromisso com para a sociedade tibiana.<br><br></font></font><center><font size="2px"><font face="Verdana"><a href="https://www.flankera.com/?points"><img src="/images/homeoffer.gif" width="690" height="80"></a></font></font><center><font size="2px"><font face="Verdana"></font>
...
<img class="Title" src="templates/tibiacom/images/header/headline-newsticker.gif" alt="Contentbox headline">    <div class="Border_2">
        <div class="Border_3">
            <div class="BoxContent" style="background-image:url(./layouts/tibiacom/images/content/scroll.gif);">
               <div align="center"><font size="2px"><font face="Verdana">What is <b>Spin</b> and <b>Win</b> ? </font></font></div><font size="2px"><font face="Verdana">
				<br><div id="TeaserThumbnail"><img src="images/spinnerii.gif" width="400px" height="200px" border="0" alt="" align="right" hspace="10"></div>
                <div id="TeaserText">
                    <div style="position: relative; top: -9px; margin-bottom: 10px;"><br>
				 <font size="2px"><font face="Verdana">
				 ➥ For each <b>sunday of every week in specific hour</b>, 
				 we will offer great gifts for loyal players throught out our spin and win panel.
				 <b>Now we prepare for it </b> and because we beleive in our players we appreciate them and we will make more and more efforts for you. <br/> <b>Thank you for supporting us.</b> <br><br></font></font><center><font size="2px"><font face="Verdana"><a href="#"><img src="/images/comingsoon.gif" width="450" height="100"></a></font></font><center><font size="2px"><font face="Verdana"></font>
                </font> </center></center></div>
	 </div>
            </font></font></div><font size="2px"><font face="Verdana">
        </font></font></div><font size="2px"><font face="Verdana">
...
<?php if(PAGE=="news"){ ?>
<div id="offer">
	<div style="width:350px; height:200px; z-index:1000; left:400px; top:200px; position:absolute;  " >
	<img id="btnclose" style="left:500px; top:500px; " height="30px" width="30px" src="/images/close.png" />
	<img id="btnbuy" style="left:550px; top:500px; " height="30px" width="90px" src="/images/buy.png" />

	<img style="left:500px; top:310px;" src="/images/offer.png" />
	</div>
	<div style="position:absolute; z-index:900; top:0px; left:0px; height:5000px; width:100%; background-color:black; opacity:0.9;" ></div>
	</div>
...
$("#btnbuy").click(function(){
			window.location.href="https://flankera.com/?points";
		});
	});
	</script>
	<?php }?>
