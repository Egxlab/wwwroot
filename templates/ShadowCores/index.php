...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $template_path; ?>/custom.css">
	...
	<body>
						...
						<ul class="nav navbar-nav navbar-left">
							<form class="navbar-form navbar-left" role="search" type="submit" method="get">
								<div class="form-group">
									...
									<input type="text" maxlength="45" name="name" class="form-control" style="max-width: 190px;" placeholder="Search Character" required />
								</div>
							</form>
						</ul>
								...
								<?php
									...
									if ($players) {
										...
										foreach($players as $player) {
											echo "<tr><td class='labelbox'>$count - <a href='?subtopic=characters&name=". $player['name']. "'>". $player['name']. "</a> <span class='label label-primary' style='float:right;'>Level: ". $player['level'] ."</span></td></<tr>";
											$count++;
										}
									}
									?>
		...
		<div class="panel panel-default">
			<div class="panel-heading" style="text-align: center;">
				...
				<b>Template by:</b> <a href="http://egxlab.com/" target="_blank">Egxlab</a>.
			</div>
		</div>
