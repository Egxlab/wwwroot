...
require_once(SYSTEM . 'pay/contenidopago/config.php');
...
PART OF contenidopago.com DISABLED, BECAUSE OF TOO MANY HACKS REPORTS. IT SHOULD STILL WORK FINE WITHOUT THAT PART!
	if($logged)
	{
		...
		if($result=='ok')
		{
			...
			$account_logged->save();
			echo 'You received ' . $points . ' premium points.';
		}
		elseif($result=='no')
		{
	...
	{
		echo '<h3>You have to login to buy points!<br /><a href="?subtopic=accountmanagement" />LOGIN HERE</a></h3>';
	}
*/
}
else
